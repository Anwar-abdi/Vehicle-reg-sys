      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 container">
        <div className="gap-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 py-12">
          ...
          <div className="space-y-4">
            <h2 className="font-Poppins font-semibold text-[#EA3C3C] text-2xl">
              CarLink
            </h2>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="#"
                className="text-gray-400 hover:text-[#EA3C3C] transition-colors duration-200"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
        ...
        {/* Bottom Bar */}
        <div className="border-gray-800 py-6 border-t text-center md:text-left">
          <div className="md:flex md:justify-between md:items-center">
            <p className="text-gray-400 text-sm">
              © {currentYear} CarLink. All rights reserved.
            </p>
